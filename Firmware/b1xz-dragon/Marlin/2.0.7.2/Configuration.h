...
#define STRING_CONFIG_H_AUTHOR "(MSA, B1XZ Dragon BLTouch)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "B1XZ"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // BIQU B1
    ...
    #define DEFAULT_Kp_LIST {  32.97,  32.97 }
    #define DEFAULT_Ki_LIST {   2.81,   2.81 }
    #define DEFAULT_Kd_LIST {  96.79,  96.79 }
  #else
    #define DEFAULT_Kp 32.97
    #define DEFAULT_Ki  2.81
    #define DEFAULT_Kd 96.79
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 9.74
  #define DEFAULT_bedKd 165.06
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 100, 50 } // ...or, set your own edit limits
#endif
...
#define NOZZLE_TO_PROBE_OFFSET { -36, -32, -1.5 }
